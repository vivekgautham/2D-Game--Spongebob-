...
public:
  ...
  Frame* getFrame(const std::string&, double);
  ...
  std::vector<Frame*> getFrames(const std::string&, double);
...
private:
  ...
  std::vector<SDL_Surface*> scaledSurfaces;
  std::vector<Frame*> scaledFrames;
  std::vector<std::vector<SDL_Surface*> > multiscaledSurfaces;
  std::vector<std::vector<Frame*> > multiscaledFrames;
